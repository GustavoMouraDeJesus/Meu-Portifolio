...
export default function Projetos() {
  ...
  return (
    <section
      id="projetos"
      className="relative w-full min-h-screen flex flex-col items-start text-white pt-20 pb-32 px-10"
    >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 w-full">
        ...
        <div className="flex flex-col items-center gap-6">
          ...
          <button
            ...
            className="w-fit px-6 py-3 border border-white hover:bg-white hover:text-black transition"
          >
            Ver descrição
          </button>
        </div>
        ...
        <div className="flex flex-col items-center gap-6 lg:col-span-2">
          <div className="relative w-full max-w-1xl mx-auto aspect-[16/7] bg-black rounded-sm overflow-hidden mt-64 mb-6">
            <video
              src="/videos/Aprovai.mp4"
              autoPlay
              muted
          ...
          <button
            onClick={() => setModalAberto(true)}
            className="w-fit px-8 py-4 border border-white text-lg hover:bg-white hover:text-black transition"
          >
            Ver descrição
          </button>
        </div>
